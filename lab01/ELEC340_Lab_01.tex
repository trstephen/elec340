...
\addbibresource{ELEC340_Lab_01.bib}
...
% lhs and rhs of Faraday
\newcommand{\eDOTdl}{\ensuremath{\oint \vec{E} \cdot d\vec{l}}}
\newcommand{\bDOTds}{{d \over dt} \int_A \vec{B} \cdot d\vec{s}}

% lhs and rhs of Ampere
\newcommand{\hDOTdl}{\oint \vec{H} \cdot d\vec{l}}
\newcommand{\dDOTds}{{d \over dt} \int_A \vec{D} \cdot d\vec{s}}
